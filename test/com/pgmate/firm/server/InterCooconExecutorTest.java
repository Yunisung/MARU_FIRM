...
public class InterCooconExecutorTest {
    InterProcess interProcess;
    Firm firm;
    private static Logger logger = LoggerFactory.getLogger(InterCooconExecutorTest.class);
...
//            socket = new Socket("10.100.200.10", 10006);
    ...
    public void makeBean() {
        CooconTransferBean cooconTransferBean = new CooconTransferBean();
        cooconTransferBean.setTRT_INST_CD("ABC");
        cooconTransferBean.setBANK_CD("007");
        cooconTransferBean.setIN_NAME("오세창");
        cooconTransferBean.setOUT_NAME("김정미");
        CooconReqBean cooconReqBean = new CooconReqBean(cooconTransferBean);
        cooconReqBean.setKEY("MY_KEY");
        cooconReqBean.setSECR_KEY("SECRET_KEY");

        String jsonParams = new Gson().toJson(cooconReqBean);
