...
public class CooconExcuter implements InterExcuter{
    ...
    String balanceKey = "";                             //�ܾ���ȸŰ
    String balanceCode = "";                             //�ܾ���ȭ�ڵ�
    String coocon_NameKey = "PbZpPBwIrutWKM13oj49";     //������ȸŰ
    String coocon_RealNameKey = "cr6YGqD57Xu2r8cSz4a7"; //�Ǹ���ȸŰ
    String regAccountKey = "wJTPdsfLZZ77wiKQtxGX";      //������µ��Ű
    String regAccountCode = "04847711";                 //������µ���ڵ�
    ...
    public FirmBean proc0100100(FirmBean firmBean) {
        ...
        try {
            ...
            firmBean.resultCd = "XXXX";
            firmBean.resultMsg = "���� ��ü ����";

            e.printStackTrace();
            logger.error("���� ��ü ���� : [{}]", e.getMessage());
        }
        return null;
    }
...
//            }
            ...
            firmBean.resultCd = "XXXX";
            firmBean.resultMsg = "���� ��ݰ��µ�� ����";

            e.printStackTrace();
            logger.error("���� ��ݰ��µ�� ���� : [{}]", e.getMessage());
        }
    ...
    public FirmBean procAccChck(FirmBean firmBean) {
        ...
        try {
            ...
            firmBean.resultCd = "XXXX";
            firmBean.resultMsg = "���� ���°��� Ȯ�� ����";

            e.printStackTrace();
            logger.error("���� ���°��� Ȯ�� ���� : [{}]", e.getMessage());
        }
        logger.info("===================================================");
