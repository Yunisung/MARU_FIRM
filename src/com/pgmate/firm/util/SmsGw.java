...
import com.pgmate.firm.dao.CodeDAO;
...
public class SmsGw {
	...
	private static Logger logger = LoggerFactory.getLogger(com.pgmate.firm.util.SmsGw.class );
	...
	public void getConfig(String smsCh) {
    	try{
            // 프로퍼티 파일 위치 
            String messagePropFile = "/home/bkwinners/MARU/MARU_FIRM/conf/messageconf.properties";
