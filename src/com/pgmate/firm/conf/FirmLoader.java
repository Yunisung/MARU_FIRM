...
public class FirmLoader {
	...
	public static void main(String args[]) {
		Firm firm = new Firm();
		firm.bank = new SharedMap<String,BankBean>();
		firm.bank.put("020", new BankBean());
		firm.server = new ServerBean();
		firm.daemon = new DaemonBean();
		
		logger.debug(GsonUtil.toJson(firm, true, ""));
	}
