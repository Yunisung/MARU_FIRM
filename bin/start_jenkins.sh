...
# JVM_ARGS for VM
##########################
JVM_ARGS="-DMARU_FIRM -server -DCP_CONF=$MARU_PATH/conf -Dlogback.configurationFile=$MARU_PATH/conf/logback.xml -Dfile.encoding=EUC-KR -Dhttps.protocols=TLSv1.3,TLSv1.2"
